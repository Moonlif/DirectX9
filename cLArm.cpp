...
void cLArm::Setup()
{
	...
	m_vecVertex[2].t = D3DXVECTOR2(15, 20);
	m_vecVertex[3].t = D3DXVECTOR2(12, 31);
	m_vecVertex[4].t = D3DXVECTOR2(15, 20);
	m_vecVertex[5].t = D3DXVECTOR2(15, 31);

	m_vecVertex[6].t = D3DXVECTOR2(0, 31);
	m_vecVertex[7].t = D3DXVECTOR2(0, 20);
	m_vecVertex[8].t = D3DXVECTOR2(3, 20);
	m_vecVertex[9].t = D3DXVECTOR2(0, 31);
	m_vecVertex[10].t = D3DXVECTOR2(3, 20);
	m_vecVertex[11].t = D3DXVECTOR2(3, 31);

	m_vecVertex[12].t = D3DXVECTOR2(8, 31);
	m_vecVertex[13].t = D3DXVECTOR2(8, 20);
	m_vecVertex[14].t = D3DXVECTOR2(11, 20);
	m_vecVertex[15].t = D3DXVECTOR2(8, 31);
	m_vecVertex[16].t = D3DXVECTOR2(11, 20);
	m_vecVertex[17].t = D3DXVECTOR2(11, 31);

	m_vecVertex[18].t = D3DXVECTOR2(4, 31);
	m_vecVertex[19].t = D3DXVECTOR2(4, 20);
	m_vecVertex[20].t = D3DXVECTOR2(7, 20);
	m_vecVertex[21].t = D3DXVECTOR2(4, 31);
	m_vecVertex[22].t = D3DXVECTOR2(7, 20);
	m_vecVertex[23].t = D3DXVECTOR2(7, 31);

	m_vecVertex[24].t = D3DXVECTOR2(4, 19);
	m_vecVertex[25].t = D3DXVECTOR2(4, 16);
	m_vecVertex[26].t = D3DXVECTOR2(7, 16);
	m_vecVertex[27].t = D3DXVECTOR2(4, 19);
	m_vecVertex[28].t = D3DXVECTOR2(7, 16);
	m_vecVertex[29].t = D3DXVECTOR2(7, 19);

	m_vecVertex[30].t = D3DXVECTOR2(8, 19);
	m_vecVertex[31].t = D3DXVECTOR2(8, 16);
	m_vecVertex[32].t = D3DXVECTOR2(11, 16);
	m_vecVertex[33].t = D3DXVECTOR2(8, 19);
	m_vecVertex[34].t = D3DXVECTOR2(11, 16);
	m_vecVertex[35].t = D3DXVECTOR2(11, 19);
